...
describe('test-project', () => {
  ...
  describe('constructor', () => {
    it('should create instance with default configuration', () => {
      ...
      const result = new TestProjectCore(config);
    ...
    it('should create instance with custom configuration', () => {
      ...
      // When: Creating instance
      const result = new TestProjectCore(customConfig);
  ...
  describe('initialize', () => {
    ...
    it('should log initialization message when debug enabled', async () => {
      ...
      instance = new TestProjectCore({ debug: true });
      const consoleSpy = vi.spyOn(console, 'log').mockImplementation(() => {});
      ...
      expect(consoleSpy).toHaveBeenCalledWith(`test-project initialized with debug mode`);
    ...
    it('should handle initialization errors gracefully', async () => {
      ...
      const errorInstance = new TestProjectCore({ debug: true });
  ...
  describe('getConfig', () => {
    it('should return current configuration', () => {
      ...
      instance = new TestProjectCore(expectedConfig);
  ...
  describe('updateConfig', () => {
    it('should update partial configuration', () => {
      ...
      instance = new TestProjectCore({ debug: false });
    ...
    it('should handle empty configuration update', () => {
      ...
      instance = new TestProjectCore(initialConfig);
