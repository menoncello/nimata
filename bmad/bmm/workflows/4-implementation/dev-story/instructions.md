...
<workflow>
  ...
  <step n="4" goal="Run quality gates and validations">
    ...
    <substep n="4.1" goal="TypeScript type checking">
      <action>Run: bunx turbo run typecheck</action>
    ...
    <substep n="4.2" goal="ESLint validation">
      <action>Run: bunx turbo run lint</action>
    ...
    <substep n="4.3" goal="Test execution">
      <action>Run: bunx turbo run test</action>
      <check>100% test pass rate required</check>
      <critical>All tests must pass with meaningful assertions</critical>
    </substep>

    <substep n="4.4" goal="Mutation testing">
      <action>Run: bunx turbo run test:mutation</action>
      <check>80%+ mutation score required</check>
      <critical>If below threshold, improve test coverage before proceeding</critical>
    </substep>
