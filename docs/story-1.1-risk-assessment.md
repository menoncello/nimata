...
**Phase 2: Routing & Parsing Verification**
4. 1.1-UNIT-002-005: Command routing unit tests
5. 1.1-UNIT-006-008: Global flag parsing
6. 1.1-INT-002: Command routing with DI

**Phase 3: Exit Code & Help Verification (Mitigates Risk #3)**
7. 1.1-UNIT-009-012: Exit code unit tests
8. 1.1-E2E-001-002: Help and version E2E tests
9. 1.1-E2E-007, 009: Exit code E2E validation
10. 1.1-E2E-008: Per-command help

**Phase 4: CI Validation (Final Gate)**
11. CI-001 through CI-004: Exit code validation in CI
